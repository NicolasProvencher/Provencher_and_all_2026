// This script was run on our private shared data server using conda as environnement manager, maxfork is to limit number of job spawned to not inconvenient other users
// Adjust paths and parameters as needed for your own environment
process FASTQ_DUMP {
    tag "$meta.GSM"
...
process TRIM_GALORE {
    ...
    script:
    // adapts input files depending on single or paired end
