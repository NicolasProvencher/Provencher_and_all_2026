...
process BOWTIE_ALIGN {
    cache 'lenient'
    // load bowtie2 program, specific to our HPC environment
    ...
    script:
    // adjust input based on single-end or paired-end sorry for long line
...
process STAR_ALIGN {
    cache 'lenient'
    // load star program, specific to our HPC environment
